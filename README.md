...
After start the server on localhost, Download ngrok, create account and set up. Tips: You can read docs of ngrok in this network: https://ngrok.com/docs/what-is-ngrok to learn how to use it.(I have already create an account, you can directly use my account to test, and I have also download a ngork exe and put it in the zip, just use it.)
